"""
RL configuration for the Crawler velocity abstraction task.
...
def crawler_ppo_abstraction_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for the Crawler velocity abstraction task."""
  return RslRlOnPolicyRunnerCfg(
      ...
      experiment_name="crawler_velocity_abstraction_ppo",
