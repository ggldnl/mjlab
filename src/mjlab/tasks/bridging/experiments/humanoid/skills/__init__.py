...
Swap in Run, Jump, Kick, Push, Front-Kick, Punch-Combo or Backflip for the other seven.
Each sub-package's __init__.py says what its task needs (policies where the robot interacts
with objects in the scene require different observations).
"""
